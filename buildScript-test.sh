...
# Copia el archivo 'test-ingress-service-transversal.yml' a la carpeta 'dist/deploy/ingresstransversal'
# para incluir las configuraciones de Ingress necesarias durante el despliegue.
cp despliegue/desarrollo/test-ingress-service-transversal.yml dist/deploy/ingresstransversal
